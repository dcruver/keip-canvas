...
class XmlSchemaHttpClientTest extends Specification {
    ...
    def "Collect HTTP/S target and import schemas success"(String uri) {
        ...
        namespaces ==~ [TARGET_NAMESPACE, FIRST_NAMESPACE, SECOND_NAMESPACE, THIRD_NAMESPACE,
                        XSD_NAMESPACE]
    ...
    private UriResolver mockUriResolver() {
        ...
        resolver.fetchUri(_ as URI) >>
                fsFixture.resolve("test-target.xsd").toFile().newInputStream()
        return resolver
    }
